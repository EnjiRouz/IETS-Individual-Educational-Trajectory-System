            ...
            <div class="form-check">Направления, на которых можно освоить профессию:
                ...
                @foreach($majors as $major)
                    <div class="form-group row bg-light">
                        <div class="col-md-1">
                            <input value="{{$major->id}}" type="checkbox" name="majors[]" onchange="checkChosenMajors()"/>
                        </div>
                        <div class="col-md-6">
