...
<div class="content">
    ...
    <div class="card-header">Создание новой дополнительной дисциплины</div>
    <div class="form big">
        <form class="login-form" action="{{route('admin.extra_subjects.store')}}" method="POST">
            @csrf
            ...
            <label for="category">Категория</label><input id="category" value="{{old("category")}}" type="text" name="category" placeholder='Программирование'/>
